          ...
          <div className="flex flex-wrap lg:items-center -mx-4">
            ...
            <div className="w-full md:w-1/2 px-4">
              <div className="relative mx-auto md:mr-0 max-w-max">
                ...
                {/* <img src="./income-tax-4097292.jpg" alt="home" /> */}
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="relative container px-4 mx-auto">
          <div className="xl:max-w-4xl mb-18 md:mb-16 mx-auto text-center">
            ...
            <p className="mb-6 text-lg md:text-xl text-coolGray-500 font-heading">
              ...
              take control of your finances.We believe a diverse team,
          ...
          <div className="relative max-w-4xl mx-auto">
            <img
              className="relative"
              src="https://cdn.pixabay.com/photo/2017/09/26/16/08/savings-2789112_1280.jpg"
              alt="landing"
            />
          </div>
        </div>
